    ...
    <div class="share_con">
        <div class="price">
            <div>
                ...
                <div class="text_con">
                    <p>
                        “标信通”集河北省招标投标最新拟在建项目、招标公告、变更公告、开标记录、中标候选人公示、中标公告等标讯信息于一体，并根据个人需求，提供多种信息类型关键字订阅推送、定制化分析结果接收查看，真正做到及时、精准、轻松获得最新标讯提醒，让投标先人一步！
                    </p>
                    <p>您在注册为“标信通”VIP会员后可以随时随地的掌握河北省相关招标及项目信息。</p>
                </div>
            </div>
        </div>
